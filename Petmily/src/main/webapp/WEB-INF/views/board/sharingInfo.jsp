...
<style>
   ...
   #Info {width:600px; height:800px; background:#f0efef; border: 0px solid black; border-radius:20px;position:fixed; top:35%; left:45%; margin:-250px 0 0 -200px; z-index:9999; display:none;
          -webkit-animation-name: animatetop;
          -webkit-animation-duration: 0.4s;
          animation-name: animatetop_Info;
          animation-duration: 0.4s
   }
   #infoDetail {width:1000px; height:700px; background:#f8f8f8; border: 0px solid black; border-radius:20px;position:fixed; top:40%; left:32%; margin:-250px 0 0 -200px; z-index:9999; display:none;
               -webkit-animation-name: animatetop;
               -webkit-animation-duration: 0.4s;
               animation-name: animatetop_InfoDetail;
               animation-duration: 0.4s
   }
    #InfoUpdate {width:600px; height:800px; background:#f8f8f8; border: 0px solid black; border-radius:20px;position:fixed; top:35%; left:45%; margin:-250px 0 0 -200px; z-index:9999; display:none;
          -webkit-animation-name: animatetop;
          -webkit-animation-duration: 0.4s;
          animation-name: animatetop_InfoUpdate;
          animation-duration: 0.4s
   }
    @keyframes animatetop_InfoDetail1 {
		from {left:45%;opacity:1}
		to {left:100%; opacity:0}
	}
	@keyframes animatetop_InfoUpdate {
		from {left:-300px;opacity:0}
		to {left:45%; opacity:1}
	}
    @keyframes animatetop_Info {
       from {top:-300px; opacity:0}
       to {top:35%; opacity:1;display:none;}
    }
   
    @keyframes animatetop_InfoDetail {
       from {top:-300px; opacity:0}
       to {top:40%; opacity:1;display:none;}
    }
...
$(document).ready(function(){
   ...
   // 수정 팝업창 닫기
   $("#infoUpdate_close").click(function(){ 
...
function infoDetail(n) {
	$.ajax({
		...
		success : function(result) {
				$("#infoDetail_container").html(result);
		}
	});
	$('#infoDetail').css('display','block');
	$("#infoDetail").css("animation-name","animatetop_InfoDetail");
	$("#infoDetail").css("animation-duration","0.4s");
	$('#mask').css('display','block');
}

function infoU() {
	$("#InfoUpdate").css('display','block');
	$("#InfoUpdate").css("animation-name","animatetop_InfoUpdate");
	$("#InfoUpdate").css("animation-duration","0.4s");
	$("#infoDetail").css("animation-name","animatetop_InfoDetail1");
	$("#infoDetail").css("animation-duration","0.4s");
	setTimeout(function() {
	...
	<div id="menu_slide_Community" style="position:absolute;width:150px;height:85px;background-color:#333;z-index:10;left:385px;border-bottom-left-radius:10px;border-bottom-right-radius:10px;">
	   ...
	   <div id="noticeList" style="position:relative;width:100%;height:850px;top:50px;">
	      <div id="notice_container" style="position:relative;width:500px;height:300px;margin:0 auto;">
	         <div style="pointer-events:none;cursor:default;position:relative;top:30px; width:500px;height:100px;margin:0 auto;text-align:center;font-size:40px;font-family: 'Do Hyeon', sans-serif;color:#333;">정보공유</div>
	         ...
	         <!-- 검색창 -->
	          ...
	          <div id="write" style="position:relative;width:100px;left:657px;top:40px;">
	          	<input type="button" value="새 글 등록" id="insertForm" style="outline:none;font-weight:bold; cursor:pointer;border:none;background-color:#F8F8F8;border-radius:10px;padding:10px 15px;">
	          </div>
	       </div>
	          ...
	          <div style="position:relative;width:1000px;margin:0 auto;top:-80px;">
	            ...
	            <c:forEach var="info" items="${infoList}">
	               <tr align="left" height="45">
	                  <td style="text-align:center;">${info.SEQ}</td>
	                  <td onclick="infoDetail(${info.SEQ})" style="cursor:pointer;">${info.TITLE}</td>
	                  <td style="text-align:center;">${info.WDATE}</td>
	                  <td style="text-align:center;">${info.CNT}</td>
	               </tr>
	            </c:forEach>
	            </table>
	            <!-- Paging Code 추가 -->
	            <table style="postion:relative;margin:0 auto;">
		            <tr>
		               <td colspan=5 align="center" height="100px"style="text-align: center;">
			               <c:forEach var="i" begin="1" end="${totalPage}">
				               <c:choose>
					               ...
					               <c:otherwise>
					                  <a href="infoList?currPage=${i}" style="text-decoration:none;">${i}</a>&nbsp;
					               </c:otherwise>
				               </c:choose>
			           	   </c:forEach>
		               </td>
		...
		<div id="mask"></div>
		<div id="Info">
      		<form id="info_form" action="infoInsert" method="post" autocomplete="off">
       		<div style="position:relative;top:100px;display:grid;">    
       			<div style="position:relative;top:-10px;font-size:30px;text-align:center;color:#9098a9;font-weight:bold;margin-top:-35px;">글 등록</div>  
        		<input type="text" name="id" value="${Login.id}" style="display:none" />
        		<select name="sub" style="position:relative; background-color:#f0efef;border:none;outline:none;width:100px;font-size:15px;color:#9098a9;font-weight:bold;top:35px;left:45px;">
        		...
        		<label for="title" class="inp">
             		<input type="text" id="title" name="title" placeholder="&nbsp;" style="left:0;width:390px;position:relative;right:50px;color:#9098a9;font-weight:bold;">
              		<span class="label"style="left:0px;color:#9098a9;font-weight:bold;">제목</span>
             		<span class="border" style="width:390px;left:0px;"></span>
         		</label>
         	</div>
         	<div style="position:relative;top:130px;">
         		<textarea id="content"name="content"rows="30" cols="70" style="outline:none;resize:none;color:#9098a9;font-weight:bold;border-radius:10px;background-color:#f0efef;position:relative;left:45px;padding:10px 10px;"></textarea>
         	</div>
          	<div class="buttonnn" style="position:absolute; top:710px;width:600px;" >
            	...
            	<button type="button" id="info_close" style="left:40;float:left;"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;&nbsp;취소</button>
          	</div>
      		</form>
   		</div>
   		...
   		<!-- 수정 팝업창 -->
		<div id="InfoUpdate">
	      	<form id="infoUpdate_form" action="infoUpdate" method="post" autocomplete="off">
	       	<div style="position:relative;top:100px;display:grid;">    
	       		<div style="position:relative;top:-10px;font-size:30px;text-align:center;color:#9098a9;font-weight:bold;margin-top:-35px;">글 수정</div> 
				<input type="text" id="seqU" name="seq" style="display:none;">
	        	<select name="sub" style="position:relative; background-color:#f8f8f8;border:none;outline:none;width:100px;font-size:15px;color:#9098a9;font-weight:bold;top:35px;left:45px;">
	        		<option value="공용">공용</option>
	        		<option value="강아지">강아지</option>
	        		<option value="고양이">고양이</option>
	        		<option value="기타">기타</option>
	        	...
	        	<label for="title" class="inp">
	             	<input type="text" id="title1" name="title" placeholder="&nbsp;" style="left:0;width:390px;position:relative;right:50px;color:#9098a9;font-weight:bold;">
	              	<span class="label"style="left:0px;color:#9098a9;font-weight:bold;">제목</span>
	             	<span class="border" style="width:390px;left:0px;"></span>
	         	</label>
	         </div>
	         <div style="position:relative;top:130px;">
	         	<textarea id="content1"name="content"rows="30" cols="70" style="outline:none;resize:none;color:#9098a9;font-weight:bold;border-radius:10px;border:2px solid #f0efef;background-color:#f8f8f8;position:relative;left:45px;padding:10px 10px;">${infoDetail.CONTENT}</textarea>
	         </div>
	         <div class="buttonnn" style="position:absolute; top:710px;width:600px;" >
	            <button type="submit" style="right:40;float:right;background-color:inherit;">수정&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i></button>
	            <button type="button" id="infoUpdate_close" style="left:40;float:left;background-color:inherit;"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;&nbsp;취소</button>
	          </div>
	      	</form>
   		</div>
   		...
   		<!-- 상세보기 -->
		<div id="infoDetail">
			<div id="infoDetail_container"></div>
   		</div>	
